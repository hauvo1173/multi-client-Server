...
void client_handler(void *p_client) 
{
    ...
    while (1) 
    {
        ...
        if (receive > 0) 
        {
            ...
            file<<np->name<<": "<<recv_buffer<<" from "<<np->ip<<endl;
        } 
...
int main()
{
    ...
    file.open ("/home/hau/Desktop/codebind.txt");
    // Create socket
    ...
    while (1) 
    {
        ...
        file <<"Client "<<inet_ntoa(client_info.sin_addr)<<" : "<<ntohs(client_info.sin_port)<<" come in.\n"<<endl;
        ...
        pthread_t id;
        if (pthread_create(&id, NULL, (void * (*)(void*))(client_handler), c) != 0) 
        {
